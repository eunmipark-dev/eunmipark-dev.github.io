...
export const projects: Project[] = [
  {
    ...
    description: 'blabla',
    imageFileName: 'project2.gif', // GIF 예시
  ...
  },
  {
    ...
    imageFileName: 'project_01.png', // GIF 예시 (기존 PNG/JPG 대신 GIF로 변경 가능)
    tech: ['React', 'Three'],
  ...
  {
    id: 5,
    title: 'Connected and automated public transport innovation',
    description: '',
    imageFileName: '',
    tech: ['Node', 'Vue', 'OpenLayers', 'Mapbox', 'PostreSql'],
